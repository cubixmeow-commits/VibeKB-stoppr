(function () {
  ...
  function explain(s) {
    ...
    $("explain-meta").innerHTML = "English copy is from <code>assets/l10n/en.json</code> and the Dart screens. Videos and images load from the Stoppr <code>assets/</code> folder next to this walkthrough, so keep this folder inside the stoppr repo when you open <code>index.html</code>.";
  }
